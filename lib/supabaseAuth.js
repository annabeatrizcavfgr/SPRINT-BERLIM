...
// manda um e-mail pra dona do app (ADMIN_NOTIFY_EMAIL) avisando que alguem pediu acesso a uma obra.
// Usa o Resend (RESEND_API_KEY) — se essas variaveis nao estiverem configuradas ainda, so pula o
// envio (sem quebrar o cadastro por causa disso: a pessoa fica "pending" mesmo sem o e-mail sair, e
// a dona ainda pode ver e aprovar em "Usuarios", dentro daquela obra).
